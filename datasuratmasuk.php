          ...
          <div class="">
            <div class="page-title">
              <div class="title_right">
                <h2>Surat Masuk > <small>Surat Ahli Waris Masuk</small></h2>
              </div>
            </div>
            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  ...
                  <a href="inputsuratmasuk.php"><button type="button" class="btn btn-success"><i class="fa fa-plus"></i> Tambah Surat Ahli Waris</button></a>
                  </form>
				  <div class="x_content">
                  <div class="x_content">
                              <?php
                              include '../koneksi/koneksi.php';
                              $sql1  		= "SELECT * FROM tb_arsipmasuk order by	id_suratmasuk asc";                        
                    ...
                    <table id="datatable" class="table table-striped table-bordered">
					  ...
					  <td colspan="3" align="center"><b> Pemberi Kuasa (Ahli Waris)</b></td>
					  <td colspan="3" align="center"><b> Penerima Kuasa</b></td>
					  <td colspan="4" align="center"><b> Keterangan Kematian</b></td>
					  <td colspan="2" align="center"> </td>
                        
					  </tr>
                          <th width="3%">No Urut</th>
						  <th width="10%">Nomor Register</th>
                      ...
                      <tbody>
                            ...
                            while($data = mysqli_fetch_array($query1)){
                              echo'<tr>
                              <td>	'. $data['nomorurut_arsipmasuk'].'  	</td>
							  <td>	'. $data['nomor_regis'].'		</td>
                              <td>	'. $data['tanggalmasuk_arsipmasuk'].'		</td>
                              <td>	'. $data['pemberi_kuasa_nama'].'	</td>
                              <td>	'. $data['alamat'].'	</td>
                              <td>	'. $data['pemberi_kuasa_hub'].'  		</td>
                              <td>	'. $data['ahli_waris_nama'].'  		</td>
                              <td>	'. $data['penerima_kuasa_alamat'].'		</td>
                              <td>  '. $data['penerima_kuasa_hub'].'  </td> 
							  <td>	'. $data['penerima_kuasa_nama'].'  		</td>
                              <td>	'. $data['nomor_kematian'].'  		</td>
